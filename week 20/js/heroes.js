let characters = `[{
    ...
    "pic":"https://n1s1.hsmedia.ru/37/39/74/373974effcc7ccd093d849e8fa062091/547x397_0xac120002_9548247751540468871.jpg",
    ...
    "pic":"https://n1s1.hsmedia.ru/41/8f/05/418f050c767eeca8854b328914c7bccc/547x397_0xac120002_20106541761540468871.jpg",
    ...
    "pic":"https://n1s1.hsmedia.ru/52/a3/e1/52a3e14a0c8f02715b763e7a20fe1c00/547x397_0xac120002_19311926741540468872.jpg",
    ...
    "pic":"https://n1s1.hsmedia.ru/9a/28/e7/9a28e7b059594fc10387669ae4bd2f22/547x397_0xac120002_20162335021540468872.jpg",
    ...
    "superPowers": "сверхчеловеческая сила искорость, выносливость, полет",
    "pic":"https://n1s1.hsmedia.ru/87/ed/c5/87edc525d8813c7b2899e04a4e562fe9/547x397_0xac120002_6444132261540468872.jpg",
    ...
    "pic":"https://n1s1.hsmedia.ru/e0/2b/55/e02b55b147eeaff9b3fe6bdbb36ff9ea/547x397_0xac120002_744074131540468872.jpg",
...
document.addEventListener("DOMContentLoaded", function(event) {
    let superH = JSON.parse(characters);
    showHeroes();
    getFromLocalStorage();
});

function showHeroes() {
    let heroes = JSON.parse(characters);
    console.log(heroes);
    let content = "";
    for (let hero of heroes) {
        content += `<div class='hero'>
        <h2 class="heroProfile" id="heroName">${hero.name}</h2>
        <div class="heroProfile" id="universe">Вселенная: ${hero.universe} </div>
        <div class="heroProfile" id="activity">Род деятельности: ${hero.activity} </div>
        <div class="heroProfile" id="friends">Друзья: ${hero.friends} </div>
        <div class="heroProfile" id="siperPower">Суперсилы: ${hero.superPowers}</div>
        <img class="heroProfile" alt="hero" src='${hero.pic}'>
        <div class="heroProfile" id="description">Подробнее: ${hero.description}</div><br>
        <div class="heroProfile">Оцените героя</div>
            <select class="heroProfile" id="rating" id="${hero.name}">
    ...
    document.getElementById("superheroesCont").innerHTML = content;
}
